                ...
                <section class="section">
                    ...
                    <div class="container my-3 ">
                        <div class="text-center ">
                            ...
                            <h6 class="mt-2 ">ASSESSMENT FORM FOR MENTAL/ INTELLECTUAL/ AUTISM SPECTRUM DISORDERS (MOH/276E)</h6>
                        </div>
                        ...
                        <form id="assessmentForm ">
                            ...
                            <table class="table table-bordered ">
                                <tr>
                                    ...
                                    <td><input class="form-control " readonly value="<?php echo $data['hospital_name']?> ">
                                    </td>
                                    <th>Date</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['assessment_date']?> ">
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered ">
                                <tr>
                                    <th>Name</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['user_name']?> "></td>
                                    <th>ID No.</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['id_number']?> "></td>
                                </tr>
                                <tr>
                                    <th>Gender</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['gender']?> "></td>
                                    <th>DOB</th>
                                ...
                                <tr>
                                    ...
                                    <th>Phone</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['mobile_number']?> ">
                                    </td>
                                    <th>County/Subcounty</th>
                                    <td><input class="form-control " readonly
                                            value="<?php echo $data['user_county']?>/<?php echo $data['user_subcounty']?> "></td>
                                </tr>
                                <tr>
                                    <!-- <th>County/Subcounty</th>
                                    <td><input class="form-control " readonly
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                    <th>Next of Kin</th>
                                    <td><input class="form-control " readonly value="<?php echo $data['next_of_kin_name']?> ">
                                    </td>
                                    <th>Relation</th>
                                    <td><input class="form-control " readonly
                            ...
                            <h6 class="mt-1">4. History</h6>
                            <table class="table table-bordered">
                                <tr>
                                    <th>Clinical History</th>
                                    <td><textarea class="form-control "
                                            readonly><?php echo $data['clinical_history']?></textarea></td>
                                </tr>
                                <tr>
                                    <th>Mental Evaluation status</th>
                                    <td><textarea class="form-control "
                                            readonly><?php echo $data['mental_status_evaluation']?></textarea>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th></th>
                                    <td><?php echo $data['feeding_score']?></td>
                                    <td><?php echo $data['toileting_score']?></td>
                                    <td><?php echo $data['grooming_score']?></td>
                                </tr> 
                            </table>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th> Dependence on Others / Level of Functioning</th>
                                    <td><?php echo $data['physical_disability_score']?></td> 
                                </tr>
                                <tr>
                                    <th>Employability/Schooling / Psychosocial Adaptability</th>
                                    <td><?php echo $data['employability_score']?></td> 
                                </tr>
                                <tr>
                                    <th colspan="3 ">Overall Binaural %</th>
                                    <td><?php echo $data['overall_binaural_percentage']?>%</td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered ">
                                <tr>
                                    ...
                                    <td><?php echo $data['duration_of_illness']?></td>
                                </tr> 

                                <tr>
                                    <th>Major Cause Disability</th>
                                    <td><?php echo $data['major_cause_disability']?></td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered ">
                                <tr>
                                    ...
                                    <td><?php echo $data['recommended_assistive_products']?></td>
                                </tr>
                                <tr>
                                    <th>Required Services</th>
                                    <td><?php echo $data['other_services_required']?></td>
                                </tr>
                            </table>
