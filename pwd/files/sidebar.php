<div class="main-sidebar sidebar-style-2 no-print">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-header">Account</li>
            <li class="dropdown">
                <a href="view_profile.php" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Account</span></a>
                <ul class="dropdown-menu">
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <!-- <a href="" class="btn btn-danger btn-lg btn-block btn-icon-split" id="logoutBtn">
