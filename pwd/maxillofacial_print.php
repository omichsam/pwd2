...
$sql = "SELECT 
    ...
    -- Maxillofacial Assessment Details
    mfa.medical_history, 
    mfa.dental_history, 
    mfa.dental_assessment, 
    mfa.conclusion, 
    mfa.recommended_assistive_products, 
    mfa.other_services_required, 
    mfa.document_path, 
    mfa.created_at
                ...
                <section class="section">
                    ...
                    <div class="container my-3 ">
                        <div class="text-center ">
                            ...
                            <h6 class="mt-2 "> ASSESSMENT FOR MAXILLOFACIAL DISABILITIES (MOH 276F)</h6>
                        </div>
                        ...
                        <form id="assessmentForm ">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td><textarea class="form-control "
                                            readonly><?= $data['medical_history'] ?></textarea></td>
                                </tr>
                                <tr>
                                    <th>Dental History</th>
                                    <td><textarea class="form-control "
                                            readonly><?= $data['dental_history'] ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Dental Assessment</th>
                                    <td><textarea class="form-control "
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['other_services_required'] ?></td>
                                </tr>
                            </table>
