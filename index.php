...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="hero-subtitle animate__animated animate__fadeIn animate__delay-1s">As a Person with
                        Disability, track your application through
            ...
            <div class="process-steps">
                ...
                <div class="process-step active animate__animated animate__fadeIn">
                    ...
                    <div class="step-content">
                        ...
                        <p class="step-description">Complete your online form with your personal details and disability
                            information.
                ...
                <div class="process-step animate__animated animate__fadeIn animate__delay-1s">
                    ...
                    <div class="step-content">
                        ...
                        <p class="step-description">The certified medical team will review your documents and may
                            request additional
                ...
                <div class="process-step animate__animated animate__fadeIn animate__delay-2s">
                    ...
                    <div class="step-content">
                        ...
                        <p class="step-description">The hospital health department verifies the medical assessment and
                            disability
                            classification.</p>
                        <span class="step-badge">Pending</span>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feature-card animate__animated animate__fadeInUp">
                        ...
                        <p class="feature-description">The streamlined process reduces wait times from weeks to days
                            with real-time
                ...
                <div class="col-md-4">
                    <div class="feature-card animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <p class="feature-description">Military-grade encryption protects your sensitive health
                            information
              ...
              process engaging.</p>
                ...
                <div class="col-md-4">
                    <div class="feature-card animate__animated animate__fadeInUp">
                        ...
                        <p class="feature-description">Complete your application and track progress from any device,
                            anytime,
                            anywhere.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <p class="feature-description">The health specialists are available round the clock to assist
                            with your
                            application.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="feature-card animate__animated animate__fadeInUp animate__delay-2s">
                        ...
                        <p class="feature-description">Immediate access to disability discounts and services upon
                            certification
                            approval.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"The assessment process made what I expected to be a stressful
                            process actually
                ...
                <div class="col-lg-4 mb-4">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"From application to approval in just 9 days! The real-time tracking
                            kept me
                ...
                <div class="col-lg-4 mb-4">
                    <div class="testimonial-card">
                        <p class="testimonial-text">"As someone with limited mobility, being able to complete everything
                            online was
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="cta-subtitle">As a person with disability, this platform is designed to make your medical
                assessment journey easier, faster and truly
                accessible.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="footer-about">Making disability assessment process transparent and accessible for Persons
          ...
          <ul class="footer-links">
            ...
            <li><a href="#"><i class="fas fa-chevron-right"></i> Benefits Guide</a></li>
                ...
                <div class="col-lg-4 col-md-4 text-light">
                    <h5 class="footer-title"> Accessibility                     <!-- Contact Us -->

                    </h5>
                    <ul class="footer-links text-light">
                        <!-- <li class="text-light"><a href="mailto:help@pwdaccess.online"><i
                                    class="fas fa-envelope text-light"></i>
                ...
                County</a></li> -->
                        <li class="text-light"><a href="#"><i class="fas fa-clock text-light"></i> Monday - Sunday 24 /
                                7 </a></li>
            ...
            const interval = setInterval(() => {
                ...
                if (width < 50) {
                    progressText.textContent = Math.floor(width) +
                        '% completed - Next step: Medical Review';
                } else if (width < 75) {
                    progressText.textContent = Math.floor(width) +
                        '% completed - Next step: Health Verification';
                } else {
                    progressText.textContent = Math.floor(width) +
                        '% completed - Next step: County Approval';
                }
            }, 50);
        }
