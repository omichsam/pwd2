...
// Fetch doctors
$sql = "SELECT * FROM officials WHERE active = 0 AND type !='county_officer' ORDER BY created_at DESC";
                    ...
                    <div class="section-body">
                        <div class="card">
                            <div class="card-header">
                                <h4>List of Unactivated Doctors</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)):
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="submit" class="btn btn-primary btn-sm" onclick="openModal('<?= $modalId ?>')">Activate</button></td>
                                            </tr>
                                            ...
                                            <div id="<?= $modalId ?>" class="custom-modal">
                                                <div class="custom-modal-content">
                                                    ...
                                                    <h3>Activate Doctor</h3> <span class="close text-right"
                                                        onclick="closeModal('<?= $modalId ?>')">&times;</span></form>
