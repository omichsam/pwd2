                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)):
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="submit" class="btn btn-primary btn-sm" onclick="openModal('<?= $modalId ?>')">View</button></td>
                                            ...
                                            <div id="<?= $modalId ?>" class="custom-modal">
                                                <div class="custom-modal-content">
                                                    ...
                                                    <p><strong>Status:</strong> <span class="badge badge-primary">Active</span></p> 
                                                    <p><strong>Joined On:</strong>
                                                        <?= htmlspecialchars($row['created_at']) ?></p>
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="closeModal('<?= $modalId ?>')">Close</button>
                                                </div>
                                            </div>
                                        <?php endwhile; ?>
                                    </tbody>
