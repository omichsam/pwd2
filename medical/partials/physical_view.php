...
$sql = "SELECT
        ...
        pda.assistive_products, pda.other_services,
        pda.conclusion_decision, pda.supporting_document,
...
<div class="section-body">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Physical Disability Assessment Section -->
            <div class="form-divider mt-4">
            ...
            foreach ($impairments as $score_field => $info): ?>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label><?php echo $info['label']; ?> Score</label>
                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($data[$score_field]); ?>"
                            readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label><?php echo $info['label']; ?> Remark</label>
                        <input type="text" class="form-control"
                            value="<?php echo htmlspecialchars($data[$info['remark']]); ?>" readonly>
                    </div>
                </div>
            <?php endforeach; ?>
            ...
            foreach ($functions as $function_field => $info): ?>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label><?php echo $info['label']; ?> Function</label>
                        <input type="text" class="form-control"
                            value="<?php echo htmlspecialchars($data[$function_field]); ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label><?php echo $info['label']; ?> Remark</label>
                        <input type="text" class="form-control"
