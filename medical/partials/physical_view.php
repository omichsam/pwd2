                 ...
                 <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" value="<?php echo htmlspecialchars($data['onset_date']); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Last Intervention Date</label>
                                            <input type="date" class="form-control" value="<?php echo htmlspecialchars($data['last_intervention_date']); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Cause of Disability</label>
                                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($data['cause_of_disability']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($data['region_assessed']); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Regions Affected</label>
                                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($data['regions_affected']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="2" readonly><?php echo htmlspecialchars($data['structural_findings']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Structural Remarks</label>
                                        <textarea class="form-control" rows="2" readonly><?php echo htmlspecialchars($data['structural_remarks']); ?></textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" rows="2" readonly><?php echo htmlspecialchars($data['assistive_products']); ?></textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Other Services</label>
                                            <textarea class="form-control" rows="2" readonly><?php echo htmlspecialchars($data['other_services']); ?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label>Conclusion Duration</label>
                                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($data['conclusion_duration']); ?>" readonly>
                                    </div>
