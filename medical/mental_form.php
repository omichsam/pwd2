        ...
        <div class="accordion" id="mentalAssessmentAccordion">
                    ...
                    <div class="accordion-body">
                        <div class="row mb-3">
                            <div class="col-md-6" hidden>
                                <input type="text" name="mental_disability" value="mental_disability" class="form-control">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="clinical_history" class="form-control" rows="3"><?php echo $clinical_history ?? '' ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label>Mental Status Evaluation</label>
                            <textarea name="mental_status_evaluation" class="form-control" rows="2"><?php echo $mental_status_evaluation ?? '' ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse">
                    <div class="accordion-body">
                        <h5>Complete the Assessment Tool Below by Scoring Appropriately</h5>
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label>Feeding</label>
                ...
                <div id="collapseThree" class="accordion-collapse collapse">
                    <div class="accordion-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="duration_of_illness" class="form-control" value="<?php echo $duration_of_illness ?? '' ?>">
                        </div>
                        <div class="mb-3">
                            <label>Major Cause of Disability</label>
                            <input type="text" name="major_cause_disability" class="form-control" value="<?php echo $major_cause_disability ?? '' ?>">
                        </div>
                        <div class="mb-3">
                            <label>Recommended Assistive Product(s)</label>
                            <input type="text" name="recommended_assistive_products" class="form-control" value="<?php echo $recommended_assistive_products ?? '' ?>">
                        </div>
                        <div class="mb-3">
                            <label>Other Required Services</label>
                            <input type="text" name="other_services_required" class="form-control" value="<?php echo $other_services_required ?? '' ?>">
                        </div>
                        <div class="mb-3">
