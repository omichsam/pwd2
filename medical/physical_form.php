              ...
              foreach ($areas as $field => $label) {
                ...
                <div class="col-md-6 mb-2">
                  ...
                  <select name="impairment_score_<?php echo $field ?>"
                    class="form-select form-select-sm structural-score">
            ...
            <div class="border p-3 rounded bg-light mb-3">
              ...
              <div class="row g-2">
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" class="form-control form-control-sm" name="score_moderate" id="score_moderate"
                    readonly>
                </div>
                <div class="col-md-2">
                  <label class="form-label small">Severe</label>
                  <input type="text" class="form-control form-control-sm" name="score_severe" id="score_severe"
                    readonly>
                </div>
                <div class="col-md-2">
                  <label class="form-label small">Complete</label>
                  <input type="text" class="form-control form-control-sm" name="score_complete" id="score_complete"
                    readonly>
                </div>
              </div>
            </div>
            ...
            <div class="border p-3 rounded bg-light mt-3 mb-2">
              ...
              <div class="row g-2">
                <div class="col-md-2">
                  ...
                  <input type="text" class="form-control form-control-sm" name="count_no_difficulty"
                    id="count_no_difficulty" readonly>
                </div>
                <div class="col-md-2">
                  <label class="form-label small">Mild</label>
                ...
                <div class="col-md-2">
                  <label class="form-label small">Moderate</label>
                  <input type="text" class="form-control form-control-sm" name="count_moderate" id="count_moderate"
                    readonly>
                </div>
                <div class="col-md-2">
                  <label class="form-label small">Severe</label>
                  <input type="text" class="form-control form-control-sm" name="count_severe" id="count_severe"
                    readonly>
                </div>
                <div class="col-md-2">
                  <label class="form-label small">Complete</label>
                  <input type="text" class="form-control form-control-sm" name="count_complete" id="count_complete"
                    readonly>
                </div>
              </div>
            </div>
