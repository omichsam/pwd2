            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" step="0.01" name="hearing_level_dbhl_left" class="form-control">
                </div>
                <div class="mb-3">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label>Hearing Level (dBHL)</label>
                  <input type="number" step="0.01" name="hearing_level_dbhl_right" class="form-control">
                </div>
                <div class="mb-3">
                  <label>Monoaural %</label>
                  <input type="number" step="0.01" name="monoaural_percent_right" class="form-control">
                </div>
              </div>
            </div>
